...
// MaxConn specifies maximum number of max simultaneous connections to mcb_server
...
//
// MaxMsgSize set the maximum message in bytes the mcb_server can receive and
